...
const PROJECTS: Record<Category, VideoProject[]> = {
  'DOCUMENTARY': [
    { id: 'dy2', title: 'Extreme Sports at a\nWorld-Class Ski Resort', thumb: 'https://img.youtube.com/vi/udE9rc49P0s/maxresdefault.jpg', videoUrl: 'https://github.com/jupbrian4/Video-Portfolio/releases/download/documentary/daermin.mp4', position: 'Director', year: '2025' },
    { id: 'dy3', title: 'Cross-Country Skiing in the\nCradle of Human Skiing', thumb: 'https://img.youtube.com/vi/bj4_aNadQNc/maxresdefault.jpg', videoUrl: 'https://github.com/jupbrian4/Video-Portfolio/releases/download/documentary/majun.mp4', position: 'Director', year: '2025' },
    { id: 'dy1', title: 'A Xinjiang Epic in Musical Notes:\nThe Twelve Muqam', thumb: 'https://img.youtube.com/vi/O00Vrtz7Qkw/maxresdefault.jpg', videoUrl: 'https://github.com/jupbrian4/Video-Portfolio/releases/download/documentary/muqam.mp4', position: 'Director', year: '2025' },
    { id: 'd0', title: "The Kran River in Altay\nin a Young Writer's Pen", thumb: 'https://img.youtube.com/vi/gA1wnXd8ORc/maxresdefault.jpg', videoUrl: 'https://github.com/jupbrian4/Video-Portfolio/releases/download/documentary/bayan.mp4', position: 'Director', year: '2025' },
    { id: 'dy6', title: 'Why a Teacher Went Viral on\nShort-Video Platforms', thumb: 'https://img.youtube.com/vi/Jl0AFNXdZ20/maxresdefault.jpg', videoUrl: 'https://github.com/jupbrian4/Video-Portfolio/releases/download/documentary/teacher.mp4', position: 'Director', year: '2025' },
    { id: 'dy7', title: 'Redefining Intangible Heritage\nwith Contemporary Art', thumb: 'https://img.youtube.com/vi/vGQk-L3D0I0/maxresdefault.jpg', videoUrl: 'https://github.com/jupbrian4/Video-Portfolio/releases/download/documentary/maxing.mp4', position: 'Director', year: '2025' },
  ],
  'COMMERCIAL': [
    ...
    { id: 'c7', title: 'Douyin (TikTok) Gold Origins:\nHainan, No Hurry', thumb: 'https://raw.githubusercontent.com/jupbrian4/Video-Portfolio/main/hainan.jpeg', videoUrl: 'https://github.com/jupbrian4/Video-Portfolio/releases/download/commc/hainan1.mp4', position: 'Director', year: '2024' },
    { id: 'c5', title: 'Douyin (TikTok) Gold Origins:\nShowing-off with Changbai Mountain', thumb: 'https://raw.githubusercontent.com/jupbrian4/Video-Portfolio/main/changbaishan.jpeg', videoUrl: 'https://github.com/jupbrian4/Video-Portfolio/releases/download/commc/changbai1.mp4', position: 'Director', year: '2024' },
    { id: 'c4', title: 'Douyin (TikTok) Gold Origins:\nJingdezhen: Perfectly Timed', thumb: 'https://raw.githubusercontent.com/jupbrian4/Video-Portfolio/main/jingdezhen.jpeg', videoUrl: 'https://github.com/jupbrian4/Video-Portfolio/releases/download/commc/jingdezhen1.mp4', position: 'Director', year: '2024' },
    { id: 'c3', title: 'GQ x Ouyang Nana Live Today', thumb: 'https://raw.githubusercontent.com/jupbrian4/Video-Portfolio/main/ouyang.jpeg', videoUrl: 'https://github.com/jupbrian4/Video-Portfolio/releases/download/commc/ouyang1.mp4', position: 'Director', year: '2023' },
    { id: 'c6', title: 'Chinese National Geographic:\nTravel to Wushan with Zetao Ning', thumb: 'https://raw.githubusercontent.com/jupbrian4/Video-Portfolio/main/hiking%20with.jpeg', videoUrl: 'https://github.com/jupbrian4/Video-Portfolio/releases/download/commc/Travel1.mp4', position: 'Director', year: '2025' },
    { id: 'c2', title: 'The Power To Rewrite Lives', thumb: 'https://raw.githubusercontent.com/jupbrian4/Video-Portfolio/main/rewrite%20lives.jpeg', videoUrl: 'https://github.com/jupbrian4/Video-Portfolio/releases/download/commc/rewrite.mp4', position: 'Director', year: '2022' },
    { id: 'c10', title: 'GQ x Kiehl’s Act Any Age', thumb: 'https://raw.githubusercontent.com/jupbrian4/Video-Portfolio/main/age.jpeg', videoUrl: 'https://github.com/jupbrian4/Video-Portfolio/releases/download/commc/kiehls.mp4', position: 'Director', year: '2023' },
    { id: 'c8', title: 'Christian Louboutin Chinese New\nYear Campaign 2025 - No.1', thumb: 'https://raw.githubusercontent.com/jupbrian4/Video-Portfolio/main/Chinese%20new%20year%201.jpeg', videoUrl: 'https://github.com/jupbrian4/Video-Portfolio/releases/download/commc/Chinese.new.year.1.mp4', position: 'Director', year: '2025' },
    { id: 'c9', title: 'Christian Louboutin Chinese New\nYear Campaign 2025 - No.2', thumb: 'https://raw.githubusercontent.com/jupbrian4/Video-Portfolio/main/Chinese%20new%20year%202.jpeg', videoUrl: 'https://github.com/jupbrian4/Video-Portfolio/releases/download/commc/Chinese.new.year.2.mp4', position: 'Director', year: '2025' },
    { id: 'c12', title: 'GQ x Chanel Late Night FM\nwith Zhilei Xin', thumb: 'https://raw.githubusercontent.com/jupbrian4/Video-Portfolio/main/late%20night.jpeg', videoUrl: 'https://github.com/jupbrian4/Video-Portfolio/releases/download/commc/chanel.mp4', position: 'Post-Production Producer', year: '2023' },
    { id: 'c11', title: 'Japan Airline\nLet dreams set sail', thumb: 'https://raw.githubusercontent.com/jupbrian4/Video-Portfolio/main/japan.jpg', videoUrl: 'https://github.com/jupbrian4/Video-Portfolio/releases/download/commc/Japan.airline.mp4', position: 'Director of Photography', year: '2023' },
  ],
  'NARRATIVE': [
    { id: 'n1', title: 'Detour', thumb: 'https://github.com/jupbrian4/Video-Portfolio/releases/download/narr/detour-window-horizontal1.jpg', videoUrl: 'https://github.com/jupbrian4/Video-Portfolio/releases/download/narr/Detour_Screener_NO.subtitle.mp4', position: 'Writer, Director', year: '2019' },
    { id: 'n2', title: 'One More Thing', thumb: 'https://github.com/jupbrian4/Video-Portfolio/releases/download/narr/one.more.thing.jpg', videoUrl: 'https://github.com/jupbrian4/Video-Portfolio/releases/download/narr/One.more.thing.mp4', position: 'Writer, Director, Editor', year: '2017' },
    { id: 'n3', title: 'Overexposed', thumb: 'https://github.com/jupbrian4/Video-Portfolio/releases/download/narr/overexposed.thumbpic.png', videoUrl: 'https://github.com/jupbrian4/Video-Portfolio/releases/download/narr/overexposed.mp4', position: 'Director of Photography', year: '2018' },
